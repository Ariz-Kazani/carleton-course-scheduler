...
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 101', 'Intro to Programming', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 102', 'Data Structures', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 100', 'Intro to Computer Science', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 103', 'Algorithms', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 104', 'Computer Organization', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 105', 'Operating Systems', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 106', 'Discrete Mathematics', 'Science', 1);

-- First year math courses for this demo 5 math courses 2 physics courses and 3 cs courses
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('MATH 100', 'Calculus I', 'Math', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('MATH 101', 'Calculus II', 'Math', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('MATH 102', 'Linear Algebra', 'Math', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('MATH 103', 'Differential Equations', 'Math', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('MATH 104', 'Probability', 'Math', 1);

-- First year economics courses for this demo, we will need 1 math course as well and 1 cs course
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('ECON 100', 'Intro to Economics', 'Economics', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('ECON 101', 'Microeconomics', 'Economics', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('ECON 102', 'Macroeconomics II', 'Economics', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('ECON 103', 'Econometrics', 'Economics', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('ECON 104', 'International Economics', 'Economics', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('BUS 101', 'Business Management', 'Business', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('BUS 102', 'Marketing', 'Business', 1);

-- Minor in business courses
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('BUS 100', 'Business Ethics', 'Business', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('BUS 104', 'Financial Accounting', 'Business', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('BUS 200', 'Corporate Finance', 'Business', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('BUS 201', 'Operations Management', 'Business', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('BUS 300', 'Business Law', 'Business', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('BUS 301', 'Human Resource Management', 'Business', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('BUS 400', 'Strategic Management', 'Business', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('BUS 401', 'International Business', 'Business', 1);

-- Physics courses
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('PHYS 100', 'Physics I', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('PHYS 101', 'Physics II', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('PHYS 102', 'Modern Physics', 'Science', 1);

-- Second year cs courses
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 200', 'Software Engineering', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 201', 'Database Systems', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 202', 'Web Development', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 203', 'Computer Networks', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 204', 'Artificial Intelligence', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 205', 'Machine Learning', 'Science', 1);
INSERT INTO `courses` (`code`, `name`, `faculty`, `credits`) VALUES ('COMP 206', 'Computer Graphics', 'Science', 1);
